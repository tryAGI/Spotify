...
The Spotify SDK provides integration with [Microsoft.Extensions.AI](https://learn.microsoft.com/en-us/dotnet/ai/microsoft-extensions-ai), enabling seamless interoperability with the unified .NET AI abstractions.

## Installation

```bash
dotnet add package Spotify
```
...
using var client = new SpotifyClient(
    apiKey: Environment.GetEnvironmentVariable("SPOTIFY_API_KEY")!);
