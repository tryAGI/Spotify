...
{
    /// <inheritdoc />
    public class ShowObjectJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Spotify.ShowObject>
    {
        /// <inheritdoc />
        public override global::Spotify.ShowObject Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var __score1 = 0;
            if (__jsonProps.Contains("episodes")) __score1++;
            var __bestScore = 0;
            var __bestIndex = -1;
            ...
            global::Spotify.ShowObjectVariant2? showObjectVariant2 = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                ...
                else if (__bestIndex == 1)
                {
                    try
                    {
                        var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::Spotify.ShowObjectVariant2), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::Spotify.ShowObjectVariant2> ??
                                       throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::Spotify.ShowObjectVariant2).Name}");
                        showObjectVariant2 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
            ...
            if (@base == null && showObjectVariant2 == null)
            {
                try
                {
            ...
            var __value = new global::Spotify.ShowObject(
                @base,
        ...
        public override void Write(
            ...
            global::Spotify.ShowObject value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
            ...
            else if (value.IsShowObjectVariant2)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::Spotify.ShowObjectVariant2), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::Spotify.ShowObjectVariant2?> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::Spotify.ShowObjectVariant2).Name}");
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.ShowObjectVariant2!, typeInfo);
            }
        }
    }
}