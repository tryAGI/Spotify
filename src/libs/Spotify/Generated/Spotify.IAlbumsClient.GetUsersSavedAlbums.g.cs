...
namespace Spotify
{
    public partial interface IAlbumsClient
    {
        ...
        global::System.Threading.Tasks.Task<global::Spotify.PagingSavedAlbumObject> GetUsersSavedAlbumsAsync(
            int? limit = default,
            int? offset = default,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Spotify.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Spotify.AutoSDKHttpResponse<global::Spotify.PagingSavedAlbumObject>> GetUsersSavedAlbumsAsResponseAsync(
            int? limit = default,
            int? offset = default,
            string? market = default,
            global::Spotify.AutoSDKRequestOptions? requestOptions = default,
