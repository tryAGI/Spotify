...
namespace Spotify
{
    public partial interface IAlbumsClient
    {
        ...
        global::System.Threading.Tasks.Task<global::Spotify.PagingSimplifiedTrackObject> GetAnAlbumsTracksAsync(
            string id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Spotify.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Spotify.AutoSDKHttpResponse<global::Spotify.PagingSimplifiedTrackObject>> GetAnAlbumsTracksAsResponseAsync(
            string id,
            string? market = default,
            int? limit = default,
            int? offset = default,
