...
namespace Spotify
{
    public partial class AudiobooksClient
    {
        ...
        private static readonly global::Spotify.EndPointSecurityRequirement s_GetAudiobookChaptersSecurityRequirement0 =
        ...
        private static readonly global::Spotify.EndPointSecurityRequirement[] s_GetAudiobookChaptersSecurityRequirements =
            new global::Spotify.EndPointSecurityRequirement[]
            {                s_GetAudiobookChaptersSecurityRequirement0,
            };
        partial void PrepareGetAudiobookChaptersArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id,
            ref string? market,
            ref int? limit,
            ref int? offset);
        partial void PrepareGetAudiobookChaptersRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            int? limit,
            int? offset);
        partial void ProcessGetAudiobookChaptersResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetAudiobookChaptersResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Get Audiobook Chapters<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::Spotify.PagingSimplifiedChapterObject> GetAudiobookChaptersAsync(
            string id,
        ...
        {
            var __response = await GetAudiobookChaptersAsResponseAsync(
                id: id,
                market: market,
                limit: limit,
                offset: offset,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Spotify.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Spotify.AutoSDKHttpResponse<global::Spotify.PagingSimplifiedChapterObject>> GetAudiobookChaptersAsResponseAsync(
            string id,
            string? market = default,
            int? limit = default,
            int? offset = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetAudiobookChaptersArguments(
            ...
            var __authorizations = global::Spotify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetAudiobookChaptersSecurityRequirements,
                operationName: "GetAudiobookChaptersAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetAudiobookChaptersRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Spotify.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Spotify.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetAudiobookChapters",
                                methodName: "GetAudiobookChaptersAsync",
                                pathTemplate: "$\"/audiobooks/{id}/chapters\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetAudiobookChaptersResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Spotify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 401)
                            {
                                ...
                                global::Spotify.GetAudiobookChaptersResponse? __value_401 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_401 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_401 = global::Spotify.GetAudiobookChaptersResponse.FromJson(__content_401, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_401 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Spotify.ApiException<global::Spotify.GetAudiobookChaptersResponse>.Create(
                            ...
                            if ((int)__response.StatusCode == 403)
                            {
                                ...
                                global::Spotify.GetAudiobookChaptersResponse2? __value_403 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_403 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_403 = global::Spotify.GetAudiobookChaptersResponse2.FromJson(__content_403, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_403 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Spotify.ApiException<global::Spotify.GetAudiobookChaptersResponse2>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if ((int)__response.StatusCode == 429)
                            {
                                ...
                                global::Spotify.GetAudiobookChaptersResponse3? __value_429 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_429 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_429 = global::Spotify.GetAudiobookChaptersResponse3.FromJson(__content_429, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_429 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Spotify.ApiException<global::Spotify.GetAudiobookChaptersResponse3>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetAudiobookChaptersResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Spotify.PagingSimplifiedChapterObject.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Spotify.AutoSDKHttpResponse<global::Spotify.PagingSimplifiedChapterObject>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Spotify.PagingSimplifiedChapterObject.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
