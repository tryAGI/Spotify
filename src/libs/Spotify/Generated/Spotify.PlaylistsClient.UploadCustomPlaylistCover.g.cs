...
namespace Spotify
{
    public partial class PlaylistsClient
    {
        ...
        private static readonly global::Spotify.EndPointSecurityRequirement s_UploadCustomPlaylistCoverSecurityRequirement0 =
        ...
        private static readonly global::Spotify.EndPointSecurityRequirement[] s_UploadCustomPlaylistCoverSecurityRequirements =
            new global::Spotify.EndPointSecurityRequirement[]
            {                s_UploadCustomPlaylistCoverSecurityRequirement0,
            };
        partial void PrepareUploadCustomPlaylistCoverArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string playlistId,
            byte[] request);
        partial void PrepareUploadCustomPlaylistCoverRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string playlistId,
            byte[] request);
        partial void ProcessUploadCustomPlaylistCoverResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task UploadCustomPlaylistCoverAsync(
            string playlistId,
        ...
        {
            await UploadCustomPlaylistCoverAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Spotify.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Spotify.AutoSDKHttpResponse> UploadCustomPlaylistCoverAsResponseAsync(
            string playlistId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareUploadCustomPlaylistCoverArguments(
            ...
            var __authorizations = global::Spotify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UploadCustomPlaylistCoverSecurityRequirements,
                operationName: "UploadCustomPlaylistCoverAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareUploadCustomPlaylistCoverRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Spotify.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Spotify.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "UploadCustomPlaylistCover",
                                methodName: "UploadCustomPlaylistCoverAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessUploadCustomPlaylistCoverResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Spotify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 401)
                            {
                                ...
                                global::Spotify.UploadCustomPlaylistCoverResponse? __value_401 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_401 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_401 = global::Spotify.UploadCustomPlaylistCoverResponse.FromJson(__content_401, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_401 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Spotify.ApiException<global::Spotify.UploadCustomPlaylistCoverResponse>.Create(
                            ...
                            if ((int)__response.StatusCode == 403)
                            {
                                ...
                                global::Spotify.UploadCustomPlaylistCoverResponse2? __value_403 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_403 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_403 = global::Spotify.UploadCustomPlaylistCoverResponse2.FromJson(__content_403, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_403 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Spotify.ApiException<global::Spotify.UploadCustomPlaylistCoverResponse2>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if ((int)__response.StatusCode == 429)
                            {
                                ...
                                global::Spotify.UploadCustomPlaylistCoverResponse3? __value_429 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_429 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_429 = global::Spotify.UploadCustomPlaylistCoverResponse3.FromJson(__content_429, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_429 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Spotify.ApiException<global::Spotify.UploadCustomPlaylistCoverResponse3>.Create(
                                    statusCode: __response.StatusCode,
