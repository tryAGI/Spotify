...
namespace Spotify
{
    ...
    public sealed class AutoSDKConditionalResponse<T>
    {
        internal AutoSDKConditionalResponse(
            bool notModified,
            string? entityTag,
            global::Spotify.AutoSDKHttpResponse<T>? response)
        {
        ...
        public global::Spotify.AutoSDKHttpResponse<T>? Response { get; }
    }
    ...
    public static class AutoSDKConditionalRequests
    {
        ...
        /// </summary>
        public static async global::System.Threading.Tasks.Task<global::Spotify.AutoSDKConditionalResponse<T>> SendAsync<T>(
            global::System.Func<global::Spotify.AutoSDKRequestOptions, global::System.Threading.CancellationToken, global::System.Threading.Tasks.Task<global::Spotify.AutoSDKHttpResponse<T>>> send,
            string? entityTag = null,
            global::Spotify.AutoSDKRequestOptions? requestOptions = null,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return new global::Spotify.AutoSDKConditionalResponse<T>(
                    notModified: false,
                    entityTag: GetEntityTag(response.Headers),
                    response: response);
            }
            catch (global::Spotify.ApiException exception)
        ...
        private static global::Spotify.AutoSDKRequestOptions CloneRequestOptions(
            global::Spotify.AutoSDKRequestOptions? source)
        {
            var clone = new global::Spotify.AutoSDKRequestOptions();
            if (source == null)
            {
                return clone;
            }
