...
namespace Spotify
{
    public partial class PlaylistsClient
    {
        ...
        private static readonly global::Spotify.EndPointSecurityRequirement s_ChangePlaylistDetailsSecurityRequirement0 =
        ...
        private static readonly global::Spotify.EndPointSecurityRequirement[] s_ChangePlaylistDetailsSecurityRequirements =
            new global::Spotify.EndPointSecurityRequirement[]
            {                s_ChangePlaylistDetailsSecurityRequirement0,
            };
        partial void PrepareChangePlaylistDetailsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string playlistId,
            global::Spotify.ChangePlaylistDetailsRequest request);
        partial void PrepareChangePlaylistDetailsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string playlistId,
            global::Spotify.ChangePlaylistDetailsRequest request);
        partial void ProcessChangePlaylistDetailsResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task ChangePlaylistDetailsAsync(
            string playlistId,
        ...
        {
            await ChangePlaylistDetailsAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Spotify.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Spotify.AutoSDKHttpResponse> ChangePlaylistDetailsAsResponseAsync(
            string playlistId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareChangePlaylistDetailsArguments(
            ...
            var __authorizations = global::Spotify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ChangePlaylistDetailsSecurityRequirements,
                operationName: "ChangePlaylistDetailsAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareChangePlaylistDetailsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Spotify.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Spotify.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "ChangePlaylistDetailsAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessChangePlaylistDetailsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Spotify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 401)
                            {
                                ...
                                global::Spotify.ChangePlaylistDetailsResponse? __value_401 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_401 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_401 = global::Spotify.ChangePlaylistDetailsResponse.FromJson(__content_401, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_401 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Spotify.ApiException<global::Spotify.ChangePlaylistDetailsResponse>.Create(
                            ...
                            if ((int)__response.StatusCode == 403)
                            {
                                ...
                                global::Spotify.ChangePlaylistDetailsResponse2? __value_403 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_403 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_403 = global::Spotify.ChangePlaylistDetailsResponse2.FromJson(__content_403, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_403 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Spotify.ApiException<global::Spotify.ChangePlaylistDetailsResponse2>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if ((int)__response.StatusCode == 429)
                            {
                                ...
                                global::Spotify.ChangePlaylistDetailsResponse3? __value_429 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_429 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_429 = global::Spotify.ChangePlaylistDetailsResponse3.FromJson(__content_429, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_429 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Spotify.ApiException<global::Spotify.ChangePlaylistDetailsResponse3>.Create(
                                    statusCode: __response.StatusCode,
        ...
        public async global::System.Threading.Tasks.Task ChangePlaylistDetailsAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Spotify.ChangePlaylistDetailsRequest
            {
                Name = name,
                Public = @public,
            ...
            await ChangePlaylistDetailsAsync(
                playlistId: playlistId,
                request: __request,
                requestOptions: requestOptions,
