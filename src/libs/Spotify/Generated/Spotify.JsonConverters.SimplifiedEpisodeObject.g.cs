...
{
    /// <inheritdoc />
    public class SimplifiedEpisodeObjectJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Spotify.SimplifiedEpisodeObject>
    {
        /// <inheritdoc />
        public override global::Spotify.SimplifiedEpisodeObject Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            object? simplifiedEpisodeObjectVariant2 = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                ...
                else if (__bestIndex == 1)
                {
                    try
                    {
                        ...
                        simplifiedEpisodeObjectVariant2 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
            ...
            if (@base == null && simplifiedEpisodeObjectVariant2 == null)
            {
                try
                {
            ...
            var __value = new global::Spotify.SimplifiedEpisodeObject(
                @base,
        ...
        public override void Write(
            ...
            global::Spotify.SimplifiedEpisodeObject value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
            ...
            else if (value.IsSimplifiedEpisodeObjectVariant2)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(object), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<object?> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(object).Name}");
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.SimplifiedEpisodeObjectVariant2!, typeInfo);
            }
        }
    }
}