...
namespace Spotify
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Spotify.AutoSDKRetryOptions Retry { get; set; } = new global::Spotify.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Spotify.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Spotify.IAutoSDKHook>();
        ...
        public global::Spotify.AutoSDKClientOptions AddHook(
            global::Spotify.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Spotify.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Spotify.AutoSDKClientOptions UseAuthorizationProvider(
            global::Spotify.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Spotify.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Spotify.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Spotify.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Spotify.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Spotify.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Spotify.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Spotify.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Spotify.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Spotify.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Spotify.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Spotify.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Spotify.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Spotify.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Spotify.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Spotify.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Spotify.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Spotify.AutoSDKClientOptions clientOptions,
            global::Spotify.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Spotify.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Spotify.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Spotify.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Spotify.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Spotify.IAutoSDKHook, global::Spotify.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Spotify.AutoSDKHookContext context)
        {
