...
namespace Spotify
{
    public partial class PlaylistsClient
    {
        ...
        private static readonly global::Spotify.EndPointSecurityRequirement s_AddItemsToPlaylistSecurityRequirement0 =
        ...
        private static readonly global::Spotify.EndPointSecurityRequirement[] s_AddItemsToPlaylistSecurityRequirements =
            new global::Spotify.EndPointSecurityRequirement[]
            {                s_AddItemsToPlaylistSecurityRequirement0,
            };
        partial void PrepareAddItemsToPlaylistArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string playlistId,
            ref int? position,
            ref string? uris,
            global::Spotify.AddItemsToPlaylistRequest request);
        partial void PrepareAddItemsToPlaylistRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? uris,
            global::Spotify.AddItemsToPlaylistRequest request);
        partial void ProcessAddItemsToPlaylistResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessAddItemsToPlaylistResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Spotify.AddItemsToPlaylistResponse> AddItemsToPlaylistAsync(
            string playlistId,
        ...
        {
            var __response = await AddItemsToPlaylistAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Spotify.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Spotify.AutoSDKHttpResponse<global::Spotify.AddItemsToPlaylistResponse>> AddItemsToPlaylistAsResponseAsync(
            string playlistId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareAddItemsToPlaylistArguments(
            ...
            var __authorizations = global::Spotify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_AddItemsToPlaylistSecurityRequirements,
                operationName: "AddItemsToPlaylistAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            __pathBuilder
                                .AddOptionalParameter("position", position?.ToString())
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareAddItemsToPlaylistRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Spotify.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Spotify.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "AddItemsToPlaylistAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessAddItemsToPlaylistResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Spotify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 401)
                            {
                                ...
                                global::Spotify.AddItemsToPlaylistResponse2? __value_401 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_401 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_401 = global::Spotify.AddItemsToPlaylistResponse2.FromJson(__content_401, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_401 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Spotify.ApiException<global::Spotify.AddItemsToPlaylistResponse2>.Create(
                            ...
                            if ((int)__response.StatusCode == 403)
                            {
                                ...
                                global::Spotify.AddItemsToPlaylistResponse3? __value_403 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_403 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_403 = global::Spotify.AddItemsToPlaylistResponse3.FromJson(__content_403, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_403 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Spotify.ApiException<global::Spotify.AddItemsToPlaylistResponse3>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if ((int)__response.StatusCode == 429)
                            {
                                ...
                                global::Spotify.AddItemsToPlaylistResponse4? __value_429 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_429 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_429 = global::Spotify.AddItemsToPlaylistResponse4.FromJson(__content_429, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_429 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Spotify.ApiException<global::Spotify.AddItemsToPlaylistResponse4>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessAddItemsToPlaylistResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Spotify.AddItemsToPlaylistResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Spotify.AutoSDKHttpResponse<global::Spotify.AddItemsToPlaylistResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Spotify.AddItemsToPlaylistResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Spotify.AddItemsToPlaylistResponse> AddItemsToPlaylistAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Spotify.AddItemsToPlaylistRequest
            {
                Uris = requestUris,
                Position = requestPosition,
            };

            return await AddItemsToPlaylistAsync(
                playlistId: playlistId,
                position: position,
                uris: uris,
                request: __request,
