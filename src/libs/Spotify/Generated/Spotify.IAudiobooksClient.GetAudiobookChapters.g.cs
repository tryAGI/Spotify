...
namespace Spotify
{
    public partial interface IAudiobooksClient
    {
        ...
        global::System.Threading.Tasks.Task<global::Spotify.PagingSimplifiedChapterObject> GetAudiobookChaptersAsync(
            string id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Spotify.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Spotify.AutoSDKHttpResponse<global::Spotify.PagingSimplifiedChapterObject>> GetAudiobookChaptersAsResponseAsync(
            string id,
            string? market = default,
            int? limit = default,
            int? offset = default,
