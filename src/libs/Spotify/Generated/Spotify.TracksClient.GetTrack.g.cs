...
namespace Spotify
{
    public partial class TracksClient
    {
        ...
        private static readonly global::Spotify.EndPointSecurityRequirement s_GetTrackSecurityRequirement0 =
        ...
        private static readonly global::Spotify.EndPointSecurityRequirement[] s_GetTrackSecurityRequirements =
            new global::Spotify.EndPointSecurityRequirement[]
            {                s_GetTrackSecurityRequirement0,
            };
        partial void PrepareGetTrackArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id,
            ref string? market);
        partial void PrepareGetTrackRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string id,
            string? market);
        partial void ProcessGetTrackResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetTrackResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        /// <summary>
        /// Get Track<br/>
        /// Get Spotify catalog information for a single track identified by its<br/>
        /// unique Spotify ID.
        /// </summary>
        /// <param name="id">
        ...
        public async global::System.Threading.Tasks.Task<global::Spotify.TrackObject> GetTrackAsync(
            string id,
            string? market = default,
            global::Spotify.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetTrackAsResponseAsync(
                id: id,
                market: market,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Spotify.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Spotify.AutoSDKHttpResponse<global::Spotify.TrackObject>> GetTrackAsResponseAsync(
            string id,
            string? market = default,
            global::Spotify.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Spotify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetTrackSecurityRequirements,
                operationName: "GetTrackAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Spotify.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Spotify.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetTrackAsync",
                                pathTemplate: "$\"/tracks/{id}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Spotify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 401)
                            {
                                ...
                                global::Spotify.GetTrackResponse? __value_401 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_401 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_401 = global::Spotify.GetTrackResponse.FromJson(__content_401, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_401 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Spotify.ApiException<global::Spotify.GetTrackResponse>.Create(
                            ...
                            if ((int)__response.StatusCode == 403)
                            {
                                ...
                                global::Spotify.GetTrackResponse2? __value_403 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_403 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_403 = global::Spotify.GetTrackResponse2.FromJson(__content_403, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_403 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Spotify.ApiException<global::Spotify.GetTrackResponse2>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if ((int)__response.StatusCode == 429)
                            {
                                ...
                                global::Spotify.GetTrackResponse3? __value_429 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_429 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_429 = global::Spotify.GetTrackResponse3.FromJson(__content_429, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_429 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Spotify.ApiException<global::Spotify.GetTrackResponse3>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetTrackResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Spotify.TrackObject.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Spotify.AutoSDKHttpResponse<global::Spotify.TrackObject>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Spotify.TrackObject.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
