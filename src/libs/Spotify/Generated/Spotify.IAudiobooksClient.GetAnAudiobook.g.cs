...
namespace Spotify
{
    public partial interface IAudiobooksClient
    {
        ...
        global::System.Threading.Tasks.Task<global::Spotify.AudiobookObject> GetAnAudiobookAsync(
            string id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Spotify.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Spotify.AutoSDKHttpResponse<global::Spotify.AudiobookObject>> GetAnAudiobookAsResponseAsync(
            string id,
            string? market = default,
            global::Spotify.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default);
