...
namespace Spotify
{
    public partial class PlayerClient
    {
        ...
        private static readonly global::Spotify.EndPointSecurityRequirement s_GetTheUsersCurrentlyPlayingTrackSecurityRequirement0 =
        ...
        private static readonly global::Spotify.EndPointSecurityRequirement[] s_GetTheUsersCurrentlyPlayingTrackSecurityRequirements =
            new global::Spotify.EndPointSecurityRequirement[]
            {                s_GetTheUsersCurrentlyPlayingTrackSecurityRequirement0,
            };
        partial void PrepareGetTheUsersCurrentlyPlayingTrackArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? market,
            ref string? additionalTypes);
        partial void PrepareGetTheUsersCurrentlyPlayingTrackRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string? market,
            string? additionalTypes);
        partial void ProcessGetTheUsersCurrentlyPlayingTrackResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetTheUsersCurrentlyPlayingTrackResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Get Currently Playing Track<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::Spotify.CurrentlyPlayingContextObject> GetTheUsersCurrentlyPlayingTrackAsync(
        ...
        {
            var __response = await GetTheUsersCurrentlyPlayingTrackAsResponseAsync(
                market: market,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Spotify.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Spotify.AutoSDKHttpResponse<global::Spotify.CurrentlyPlayingContextObject>> GetTheUsersCurrentlyPlayingTrackAsResponseAsync(
            string? market = default,
            string? additionalTypes = default,
            global::Spotify.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetTheUsersCurrentlyPlayingTrackArguments(
            ...
            var __authorizations = global::Spotify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetTheUsersCurrentlyPlayingTrackSecurityRequirements,
                operationName: "GetTheUsersCurrentlyPlayingTrackAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetTheUsersCurrentlyPlayingTrackRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Spotify.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Spotify.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetTheUsersCurrentlyPlayingTrackAsync",
                                pathTemplate: "\"/me/player/currently-playing\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetTheUsersCurrentlyPlayingTrackResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Spotify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 401)
                            {
                                ...
                                global::Spotify.GetTheUsersCurrentlyPlayingTrackResponse? __value_401 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_401 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_401 = global::Spotify.GetTheUsersCurrentlyPlayingTrackResponse.FromJson(__content_401, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_401 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Spotify.ApiException<global::Spotify.GetTheUsersCurrentlyPlayingTrackResponse>.Create(
                            ...
                            if ((int)__response.StatusCode == 403)
                            {
                                ...
                                global::Spotify.GetTheUsersCurrentlyPlayingTrackResponse2? __value_403 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_403 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_403 = global::Spotify.GetTheUsersCurrentlyPlayingTrackResponse2.FromJson(__content_403, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_403 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Spotify.ApiException<global::Spotify.GetTheUsersCurrentlyPlayingTrackResponse2>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if ((int)__response.StatusCode == 429)
                            {
                                ...
                                global::Spotify.GetTheUsersCurrentlyPlayingTrackResponse3? __value_429 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_429 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_429 = global::Spotify.GetTheUsersCurrentlyPlayingTrackResponse3.FromJson(__content_429, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_429 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Spotify.ApiException<global::Spotify.GetTheUsersCurrentlyPlayingTrackResponse3>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetTheUsersCurrentlyPlayingTrackResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
