...
namespace Spotify
{
    public partial class PlayerClient
    {
        ...
        private static readonly global::Spotify.EndPointSecurityRequirement s_SeekToPositionInCurrentlyPlayingTrackSecurityRequirement0 =
        ...
        private static readonly global::Spotify.EndPointSecurityRequirement[] s_SeekToPositionInCurrentlyPlayingTrackSecurityRequirements =
            new global::Spotify.EndPointSecurityRequirement[]
            {                s_SeekToPositionInCurrentlyPlayingTrackSecurityRequirement0,
            };
        partial void PrepareSeekToPositionInCurrentlyPlayingTrackArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref int positionMs,
            ref string? deviceId);
        partial void PrepareSeekToPositionInCurrentlyPlayingTrackRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            int positionMs,
            string? deviceId);
        partial void ProcessSeekToPositionInCurrentlyPlayingTrackResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task SeekToPositionInCurrentlyPlayingTrackAsync(
            int positionMs,
            string? deviceId = default,
            global::Spotify.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            await SeekToPositionInCurrentlyPlayingTrackAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Spotify.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Spotify.AutoSDKHttpResponse> SeekToPositionInCurrentlyPlayingTrackAsResponseAsync(
            int positionMs,
            string? deviceId = default,
            global::Spotify.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareSeekToPositionInCurrentlyPlayingTrackArguments(
                httpClient: HttpClient,
                positionMs: ref positionMs,
                deviceId: ref deviceId);


            var __authorizations = global::Spotify.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_SeekToPositionInCurrentlyPlayingTrackSecurityRequirements,
                operationName: "SeekToPositionInCurrentlyPlayingTrackAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Spotify.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Spotify.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "SeekToPositionInCurrentlyPlayingTrackAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessSeekToPositionInCurrentlyPlayingTrackResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Spotify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 401)
                            {
                                ...
                                global::Spotify.SeekToPositionInCurrentlyPlayingTrackResponse? __value_401 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_401 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_401 = global::Spotify.SeekToPositionInCurrentlyPlayingTrackResponse.FromJson(__content_401, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_401 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Spotify.ApiException<global::Spotify.SeekToPositionInCurrentlyPlayingTrackResponse>.Create(
                            ...
                            if ((int)__response.StatusCode == 403)
                            {
                                ...
                                global::Spotify.SeekToPositionInCurrentlyPlayingTrackResponse2? __value_403 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_403 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_403 = global::Spotify.SeekToPositionInCurrentlyPlayingTrackResponse2.FromJson(__content_403, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_403 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Spotify.ApiException<global::Spotify.SeekToPositionInCurrentlyPlayingTrackResponse2>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if ((int)__response.StatusCode == 429)
                            {
                                ...
                                global::Spotify.SeekToPositionInCurrentlyPlayingTrackResponse3? __value_429 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_429 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_429 = global::Spotify.SeekToPositionInCurrentlyPlayingTrackResponse3.FromJson(__content_429, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_429 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Spotify.ApiException<global::Spotify.SeekToPositionInCurrentlyPlayingTrackResponse3>.Create(
                                    statusCode: __response.StatusCode,
