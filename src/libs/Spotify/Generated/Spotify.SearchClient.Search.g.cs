...
namespace Spotify
{
    public partial class SearchClient
    {
        ...
        private static readonly global::Spotify.EndPointSecurityRequirement s_SearchSecurityRequirement0 =
        ...
        private static readonly global::Spotify.EndPointSecurityRequirement[] s_SearchSecurityRequirements =
            new global::Spotify.EndPointSecurityRequirement[]
        ...
        partial void PrepareSearchArguments(
            ...
            ref int? limit,
            ref int? offset,
            ref global::Spotify.SearchIncludeExternal? includeExternal);
        partial void PrepareSearchRequest(
            ...
            int? limit,
            int? offset,
            global::Spotify.SearchIncludeExternal? includeExternal);
        ...
        public async global::System.Threading.Tasks.Task<global::Spotify.SearchResponse> SearchAsync(
            string q,
            global::System.Collections.Generic.IList<global::Spotify.SearchTypeItem> type,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Spotify.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Spotify.AutoSDKHttpResponse<global::Spotify.SearchResponse>> SearchAsResponseAsync(
            string q,
            global::System.Collections.Generic.IList<global::Spotify.SearchTypeItem> type,
            string? market = default,
            int? limit = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareSearchArguments(
                ...
                limit: ref limit,
                offset: ref offset,
                includeExternal: ref includeExternal);
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            __pathBuilder
                                ...
                                .AddRequiredParameter("type", type, selector: static x => x.ToValueString(), delimiter: ",", explode: false)
                                .AddOptionalParameter("market", market)
                                .AddOptionalParameter("limit", limit?.ToString())
                                .AddOptionalParameter("offset", offset?.ToString())
                                .AddOptionalParameter("include_external", includeExternal?.ToValueString())
                                ;
                ...
                else
                {
                    await global::Spotify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 401)
                            {
                                ...
                                global::Spotify.SearchResponse2? __value_401 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_401 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_401 = global::Spotify.SearchResponse2.FromJson(__content_401, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_401 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Spotify.ApiException<global::Spotify.SearchResponse2>.Create(
                            ...
                            if ((int)__response.StatusCode == 403)
                            {
                                ...
                                global::Spotify.SearchResponse3? __value_403 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_403 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_403 = global::Spotify.SearchResponse3.FromJson(__content_403, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_403 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Spotify.ApiException<global::Spotify.SearchResponse3>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if ((int)__response.StatusCode == 429)
                            {
                                ...
                                global::Spotify.SearchResponse4? __value_429 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_429 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_429 = global::Spotify.SearchResponse4.FromJson(__content_429, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_429 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Spotify.ApiException<global::Spotify.SearchResponse4>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Spotify.SearchResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Spotify.AutoSDKHttpResponse<global::Spotify.SearchResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Spotify.SearchResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
