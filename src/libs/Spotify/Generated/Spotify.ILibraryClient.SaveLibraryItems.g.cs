...
namespace Spotify
{
    public partial interface ILibraryClient
    {
        ...
        global::System.Threading.Tasks.Task SaveLibraryItemsAsync(
            string uris,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Spotify.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Spotify.AutoSDKHttpResponse> SaveLibraryItemsAsResponseAsync(
            string uris,
            global::Spotify.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default);
    }
