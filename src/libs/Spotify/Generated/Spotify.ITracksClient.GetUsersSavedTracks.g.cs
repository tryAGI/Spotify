...
namespace Spotify
{
    public partial interface ITracksClient
    {
        ...
        global::System.Threading.Tasks.Task<global::Spotify.PagingSavedTrackObject> GetUsersSavedTracksAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Spotify.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Spotify.AutoSDKHttpResponse<global::Spotify.PagingSavedTrackObject>> GetUsersSavedTracksAsResponseAsync(
            string? market = default,
            int? limit = default,
            int? offset = default,
            global::Spotify.AutoSDKRequestOptions? requestOptions = default,
