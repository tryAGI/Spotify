...
namespace Spotify
{
    public partial interface IPlayerClient
    {
        ...
        global::System.Threading.Tasks.Task SkipUsersPlaybackToPreviousTrackAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Spotify.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Spotify.AutoSDKHttpResponse> SkipUsersPlaybackToPreviousTrackAsResponseAsync(
            string? deviceId = default,
            global::Spotify.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default);
    }
